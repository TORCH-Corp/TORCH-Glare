...
export function FieldSection({
    ...
    return (
        <section {...props} className={cn("flex flex-col gap-[12px] flex-1 border-t border-[--border-presentation-global-primary] py-[16px] px-[12px] max-w-[1200px] sm:gap-[24px] sm:flex-row", className)} >
