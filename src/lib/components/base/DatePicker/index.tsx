...
export const Datepicker = forwardRef(
  (props: Props, ref: ForwardedRef<ReactDatePicker>) => {
    ...
    return (
      <section
        style={props.style}
        className={`w-full glare-date-picker glare-date-picker-${
          props.component_size || "S"
        } glare-date-picker-${props.component_style} ${
          focus && "show-datepicker-icon"
        } ${props.onTableCell && "glare-date-picker-on-table-cell"}`}
      >
        <DatePicker
          selected={startDate}
          onChange={(date: any) => {
        ...
        <span className="glare-date-picker-icon">
