    ...
    variants: {
      variant: {
        ...
        SystemStyle: [
          ...
          "data-[state=active]:bg-background-system-action-primary-selected",
          "data-[state=active]:text-content-system-global-primary",
        ],
        Underline: [
          "px-3 pb-2 -mb-[1px]",
          "text-content-presentation-global-secondary",
        ...
        Pills: [
          ...
          "text-content-presentation-global-secondary",
          "hover:text-content-presentation-tab-action-hover",
          "data-[state=active]:bg-background-presentation-action-primary",
          "data-[state=active]:text-content-presentation-action-light-primary",
        ],
      },
      size: {
        S: ["h-[22px]", "text-[12px]"],
