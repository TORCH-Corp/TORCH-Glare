      ...
      <Popover>
        ...
        >
          ...
          <div
            ...
            style={{
              maskImage:
                "linear-gradient(to top, transparent, transparent 10%, white 50%, white 19%, transparent 75%, transparent)",
              WebkitMaskImage:
                "linear-gradient(to top, transparent, transparent 10%, white 50%, white 19%, transparent 75%, transparent)",
            }}
          >
...
const IosPickerItem: React.FC<PropType> = ({
  ...
  return (
    <div {...props} className="flex items-center justify-center w-[90px] h-full text-[1.8rem]">
      <div
        className="min-w-full h-full flex items-center justify-center overflow-hidden touch-pan-x"
        ref={rootNodeRef}
      >
        <div
          className={`w-[75px] h-[32px] perspective-[3200px] select-none ${
            perspective === "left"
...
const SliderItem = (props: SliderItemType) => {
  return (
    <div
      className="w-full h-full text-[19px] text-center flex items-center justify-center [backface-visibility:hidden] opacity-0"
      {...props}
    >
      {props.children}
    </div>
