...
export default function TreeSubLayout({
  ...
  return (
    <div className="grid grid-rows-[64px_1fr] h-full gap-[2px]">
      ...
      <div className="grid grid-cols-[1fr_300px] overflow-hidden border border-border-presentation-global-primary bg-background-presentation-form-base">
        {/* Children Container (Scrollable) */}
        <div className=" scrollbar-hide overflow-scroll scroll-smooth px-[20px] bg-background-system-body-base bg-[linear-gradient(0deg,_var(--background-system-body-base)_0%,_rgba(178,208,255,0.05)_100%)]">
          {children}
        </div>

        {/* Sidebar (Fixed) */}
        <div className="border-l border-border-presentation-global-primary bg-background-system-body-base scrollbar-hide">
